#include<iostream>
#include <cstdlib>
#include <windows.h>  //used to change color of background and text
using namespace std;
...
public:
    void cal()   //to calculate the final amount of the bill
    {
        ...
        int i=1;
            ...
            while(temp!=NULL)
            {
                amount = amount + (temp->price*temp->no);
            ...
            display();
            cout<<"__________________________________________________________"<<endl;
            cout<<" Amount of bill is: Rs."<<amount<<endl;
...
{
    int choice=1;
    system("Color F3");  //color scheme: F-white 3-Aqua
    cout<<"____________________________________________________________"<<endl;
